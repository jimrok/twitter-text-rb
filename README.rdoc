...
# This is a modify version of twitter-text, we add such feather to this gem file.
* add the chinese charset support in to @ targ, for example: @大雄.
* add an enhancement to hashtag by  support numberic tag with symbol '#', for example "#123" will link to numberic_hashtag.
